...
QT_MOC_LITERAL(3, 39, 13) // "update_region"
...
void canvas_image_label::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->update_region((*reinterpret_cast< QPoint(*)>(_a[1])),(*reinterpret_cast< QPoint(*)>(_a[2]))); break;
        default: ;
        }
        ...
        {
            typedef void (canvas_image_label::*_t)(QPoint , QPoint );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&canvas_image_label::update_region)) {
                *result = 1;
                return;
            }
        }
...
const QMetaObject canvas_image_label::staticMetaObject = {
    { &QLabel::staticMetaObject, qt_meta_stringdata_canvas_image_label.data,
...
// SIGNAL 1
void canvas_image_label::update_region(QPoint _t1, QPoint _t2)
{
