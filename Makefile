#############################################################################
# Makefile for building: VC
# Generated by qmake (3.1) (Qt 5.9.2)
# Project:  VC.pro
# Template: subdirs
# Command: /usr/bin/qmake -o Makefile VC.pro
#############################################################################
...
COMPRESS      = gzip -9f
DISTNAME      = VC1.0.0
DISTDIR = /home/darias/ULL/VC/vision_computador/.tmp/VC1.0.0
SUBTARGETS    =  \
		sub-src \
		sub-src-plugins--
...
Makefile: VC.pro /usr/lib/qt/mkspecs/linux-g++/qmake.conf /usr/lib/qt/mkspecs/features/spec_pre.prf \
